...
(* parse a program from a string *)
  ...
  val prog_parse : string -> Absyn.Program 

(* parse a query from a string *)

  val query_parse : string -> Absyn.Program

(* parse a program in a file *)

  val file_parse : string -> Absyn.Program
 
(* parse a query from the standard input *)

  val top_parse : unit -> Absyn.Program
...
fun parse (dummyToken,lookahead,reader : int -> string) =
	...
	fun invoke lexer = 
	   ...
	   val _ = Compiler.Control.Print.printDepth:=20;
